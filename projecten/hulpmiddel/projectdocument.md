...
| 13 | Technische onderbouwing ([opdracht-onderbouwing.html](opdracht-onderbouwing.html)) | 3–5 pagina's: probleem, PvE, ontwerpkeuzes, tolerantieberekening, printoriëntatie, materiaalkeuze, beide iteraties, testresultaten, en de definitieve antwoorden op de 6 deelvragen (uit je logboek), plus het **antwoord van je expert** (met bronvermelding) en een alinea die je product koppelt aan **minstens drie SDG's**. Met foto's van je maakwerk (schetsen, kartonmodel, prototypes, breukvlakken, eindproduct). Invullen op de opdracht Technische onderbouwing, inleveren als PDF. | Delen | Les 10 |
...
| **9** | Afwerken + onderbouwing | Afwerken (randen ontbramen, geen scherpe delen, dopmoeren). Technische onderbouwing schrijven op de [opdracht Technische onderbouwing](opdracht-onderbouwing.html): waarom PETG, waarom deze oriëntatie, welke speling en waarom, welke twee iteraties en wat leverden die op — inclusief het expertantwoord (met bron), de SDG-koppeling en foto's van je maakwerk. **Zelfcheck 2:** leg je werk nog één keer naast de rubric ([werkblad-zelfcheck.html](werkblad-zelfcheck.html)) en bepaal je laatste verbeterstap vóór de presentatie. Presentatie voorbereiden. | Concept-onderbouwing + zelfcheck |
...
- FDM-printers, PLA én PETG beschikbaar.
...
*Aan de scootmobiel:* sleutel eruit, accu los, parkeerrem erop, wielen geblokkeerd. Er wordt niet in gereden. Er wordt niet in het frame geboord. De veiligheidsgrenzen ("mag wél / mag niet", zie hierboven) gelden zonder uitzondering en worden in les 2 klassikaal behandeld en ondertekend.
